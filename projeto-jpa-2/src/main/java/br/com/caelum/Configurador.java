...
public class Configurador extends WebMvcConfigurerAdapter {
	...
	@Bean
	public OpenEntityManagerInViewInterceptor getOpenEntintyManagerInViewInterceptor() {
		return new OpenEntityManagerInViewInterceptor();
	}
	
	@Override
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addWebRequestInterceptor(getOpenEntintyManagerInViewInterceptor());
	}
