...
<head>
  <meta charset="utf-8">
  <title>Banco Brasil | Cadastro de Categoria</title>
...
<body>
  ...
  <div class="py-5 text-center" style="background-image: url('https://static.pingendo.com/cover-bubble-dark.svg');background-size:cover;">
    <div class="container">
      <div class="row">
        <div class="mx-auto col-md-6 Categoria bg-white p-5">
          <h1 class="mb-4">Cadastro de Categoria</h1>
          <form action="/bancobrasil/in?acao=AdicionarCategoria" method="post">
            <div class="form-group"><h5 > <b>Nome da Categoria para Profissão:</b> </h5> <input type="text" class="form-control" placeholder="Nome" name ="nome" id="form9"> </div>
